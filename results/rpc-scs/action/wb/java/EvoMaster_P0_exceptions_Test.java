...
/**
*  This file was automatically generated by EvoMaster on 2024-11-03T02:56:30.598-03:00[America/Argentina/Buenos_Aires]
 * <br>
...
public class EvoMaster_P0_exceptions_Test {
    ...
    @Test(timeout = 60000)
    public void test_0_scsServiceBlockingStubOnCookieThrowsRuntimeException() throws Exception {
        ...
        try{
            ...
            org.grpc.scs.generated.DtoResponse res_0 = null;
            {
             org.grpc.scs.generated.CookieRequest arg0 = null;
             {
              ...
              arg0builder.setName("HkhYGB");
              arg0builder.setVal(null);
              arg0builder.setSite("_EM_36_XYZ_");
    ...
    @Test(timeout = 60000)
    public void test_1_scsServiceBlockingStubOnTitleThrowsRuntimeException() throws Exception {
    ...
    @Test(timeout = 60000)
    public void test_2_scsServiceBlockingStubOnOrdered4ThrowsRuntimeException() throws Exception {
        ...
        try{
            ...
            org.grpc.scs.generated.DtoResponse res_0 = null;
            {
             org.grpc.scs.generated.Ordered4Request arg0 = null;
             {
              ...
              arg0builder.setW("o5");
              arg0builder.setX("u9Yuc");
              arg0builder.setZ(null);
              arg0builder.setY("Sr7i21VM0ctUjJj7");
              arg0 = arg0builder.build();
             }
    ...
    @Test(timeout = 60000)
    public void test_3_scsServiceBlockingStubOnPatThrowsRuntimeException() throws Exception {
    ...
    @Test(timeout = 60000)
    public void test_4_scsServiceBlockingStubOnRegexThrowsRuntimeException() throws Exception {
    ...
    @Test(timeout = 60000)
    public void test_5_scsServiceBlockingStubOnDateParseThrowsRuntimeException() throws Exception {
        ...
        try{
            ...
            org.grpc.scs.generated.DtoResponse res_0 = null;
            {
             org.grpc.scs.generated.DateParseRequest arg0 = null;
             {
              ...
              arg0builder.setMonthname("_EM_33_XYZ_");
              arg0 = arg0builder.build();
             }
        ...
        try{
            ...
            org.grpc.scs.generated.DtoResponse res_0 = null;
            {
             org.grpc.scs.generated.Text2txtRequest arg0 = null;
             {
              ...
              arg0builder.setWord2("_EM_5_XYZ_");
              arg0builder.setWord3("ZM6GcHM_VXkg");
              arg0 = arg0builder.build();
             }
    ...
    @Test(timeout = 60000)
    public void test_8_scsServiceBlockingStubOnCalcThrowsRuntimeException() throws Exception {
        ...
        try{
            ...
            org.grpc.scs.generated.DtoResponse res_0 = null;
            {
             org.grpc.scs.generated.CalcRequest arg0 = null;
             {
              ...
              arg0builder.setArg1(0.39263514321854043);
              arg0builder.setArg2(0.7190962211600554);
              arg0 = arg0builder.build();
             }
    ...
    @Test(timeout = 60000)
    public void test_10_scsServiceBlockingStubOnFileSuffixThrowsRuntimeException() throws Exception {
